    ...
    <div className="relative lg:mx-[5vh] md:mx-[3vh] mx-[1vh] lg:p-2 p-1">
      ...
      >
        <div className="flex lg:text-lg md:text-base text-sm lg:gap-8 md:gap-6 gap-4 hover:cursor-default lg:mr-8 md:mr-6 mr-4 font-light">
          <div className="flex items-center md:gap-2 gap-1"><BotIcon strokeWidth={0.8} />Live AI Interviewers</div>
          <div className="flex items-center md:gap-2 gap-1"><DramaIcon strokeWidth={0.8} />Custom Roles</div>
          <div className="flex items-center md:gap-2 gap-1"><ZapIcon strokeWidth={0.8} />Instant Interviews</div>
          ...
          <div className="flex items-center md:gap-2 gap-1"><FileVideoIcon strokeWidth={0.8} />Interview Replays</div>
