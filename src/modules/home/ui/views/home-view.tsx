  ...
  return (
    <div className="w-full flex flex-col md:gap-12 gap-8 relative">
      ...
      <Card id="about" className="overflow-hidden lg:px-2 px-1 py-2 lg:mx-[5vh] md:mx-[3vh] mx-[1vh] rounded-none">
        <CardContent className="flex justify-between items-center">
          <div className="lg:w-[60%] w-full flex flex-col gap-6 md:py-20 py-10">
            ...
            <p className="lg:text-xl md:text-lg text-base font-medium">AI interviewers that join, listen, and contribute in real time.</p>
            <div className="flex md:gap-5 gap-2.5">
              <Link href="/sign-up">
                <Button className="lg:text-base md:text-sm text-xs rounded-none">Create a interview</Button>
              </Link>
              <Button 
                onClick={() => {
                    const el = document.getElementById("workflow");
                  ...
                  <Card className="rounded-none lg:px-2 md:px-5 px-1 lg:py-10 md:py-5 py-3 flex-1">
                    <CardContent className="flex items-center lg:gap-4 md:gap-14 gap-8">
                      ...
                      <div className="flex flex-col lg:gap-4 md:gap-3 gap-2">
                        ...
                        <p className="lg:text-base md:text-sm text-xs">Join meetings with AI interviewers that actively understand, assist, and enhance collaboration.</p>
                      </div>
                    </CardContent>
                  </Card>
                  <Card className="rounded-none lg:px-2 md:px-5 px-1 lg:py-10 md:py-5 py-3 flex-1">
      ...
      <div id="workflow" className="flex flex-col justify-center items-center lg:gap-14 md:gap-12 gap-10 py-5 lg:mx-[5vh] md:mx-[3vh] mx-[1vh]">
          ...
          <div className="flex md:flex-row flex-col md:justify-between justify-center items-center w-full lg:px-32 px-2 md:pb-0 pb-6">
            ...
            <div className="flex flex-col text-center md:gap-4 gap-2 md:mt-0 mt-3">
              <p className="lg:text-xl md:text-lg text-base font-medium">1. Create Your AI Interviewer</p>
              <p className="lg:text-base md:text-sm text-xs">
                Define your interviewer’s role, tone, and purpose - from tutor to mentor to sales coach.
              </p>
            </div>
          </div>
          ...
          <div className="flex md:flex-row flex-col-reverse md:justify-between justify-center items-center w-full lg:px-32 px-2 md:pb-0 pb-6">
            <div className="flex flex-col text-center md:gap-4 gap-2 lg:pl-20 pl-5 md:mt-0 mt-3">
              <p className="lg:text-xl md:text-lg text-base font-medium">2. Schedule a Interview</p>
              <p className="lg:text-base md:text-sm text-xs">
                Set up a interview, select your AI interviewer, and step into the lobby.
              </p>
            </div>
            <div className="flex justify-center items-center rounded-none md:w-[45%] w-[90%] border-b-2 md:px-4 px-2 transform lg:scale-100 md:scale-95 scale-75 overflow-hidden">
            <MotionCard 
              ...
              <CardContent className="flex items-center lg:px-3 px-2">
                <form className="space-y-2">
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs font-medium">Interview Name</Label>
          ...
          <div className="flex md:flex-row flex-col md:justify-between justify-center items-center w-full lg:px-32 px-2 md:pb-0 pb-6">
            ...
            <MotionCard 
              ...
              <CardContent className="flex flex-col space-y-2 items-center px-2">
                <div className="lg:h-[15vh] h-[8vh] w-[80%] border border-gray-400 flex flex-col justify-center items-center gap-1">
                  ...
                  <p className="text-xs font-light">Product Analyst Interviewer</p>
                </div>
            ...
            <div className="flex flex-col text-center md:gap-4 gap-2 md:mt-0 mt-3">
              ...
              <p className="lg:text-base md:text-sm text-xs">
                Collaborate in real time as your interviewer listens, responds, and participates naturally.
              </p>
            </div>
          </div>
          <div className="flex md:flex-row flex-col-reverse md:justify-between justify-center items-center w-full lg:px-32 px-2 md:pb-0 pb-6">
          ...
          <div className="flex md:flex-row flex-col justify-center items-center w-full lg:gap-4 gap-0 relative">
            <Card className="rounded-none lg:w-[25%] md:w-[30%] w-[75%] transform md:scale-100 scale-95 relative z-10">
              <CardContent className="flex flex-col justify-center items-center lg:gap-8 gap-4 md:px-6 px-2">
                ...
                <div className="flex flex-col items-start w-full gap-y-2.5">
                  ...
                  <p className="text-xs font-medium flex items-center gap-x-2.5"><CircleCheckIcon className="size-4 fill-primary text-white" />Unlimited Interviewers</p>
                  <p className="text-xs font-medium flex items-center gap-x-2.5"><CircleCheckIcon className="size-4 fill-primary text-white" />Unlimited Interviews</p>
            ...
            <Card className="rounded-none lg:w-[25%] md:w-[33%] w-[80%] bg-black text-white transform lg:scale-105 md:scale-110 scale-95 relative z-30">
              <CardContent className="flex flex-col justify-center items-center lg:gap-8 gap-4 md:px-6 px-2">
                ...
                <div className="flex flex-col items-start w-full gap-y-2.5">
                  <p className="font-medium text-sm mb-4">FEATURES</p>
                  <p className="text-xs font-medium flex items-center gap-x-2.5"><CircleCheckIcon className="size-4 fill-white text-black" />Unlimited Interviewers</p>
                  <p className="text-xs font-medium flex items-center gap-x-2.5"><CircleCheckIcon className="size-4 fill-white text-black" />Unlimited Interviews</p>
            ...
            <Card className="rounded-none lg:w-[25%] md:w-[30%] w-[75%] transform md:scale-100 scale-95 relative z-10">
              <CardContent className="flex flex-col justify-center items-center lg:gap-8 gap-4 md:px-6 px-2">
                ...
                <div className="flex flex-col items-start w-full gap-y-2.5">
                  ...
                  <p className="text-xs font-medium flex items-center gap-x-2.5"><CircleCheckIcon className="size-4 fill-primary text-white" />Unlimited Interviewers + Interviews</p>
      ...
      <div className="flex flex-col justify-center items-center lg:gap-4 gap-2 lg:py-20 py-10 lg:mx-[5vh] md:mx-[2vh] mx-[1vh]">
          ...
          <p className="lg:text-lg md:text-base text-sm font-medium text-center text-black/75">Start your first AI-Powered interview today and see how effortless collaboration can be.</p>
