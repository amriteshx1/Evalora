...
import { NewAgentDialog } from "@/modules/interviewers/ui/components/new-interviewer-dialog";
...
export const MeetingForm = ({
    ...
    const  form = useForm<z.infer<typeof meetingsInsertSchema>>({
        ...
        defaultValues: {
            ...
            interviewerId: initialValues?.interviewerId ?? "",
        },
    });
              ...
              <FormField 
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <CommandSelect  
                              options={(interviewers.data?.items ?? []).map((interviewer) => ({
                                id: interviewer.id,
